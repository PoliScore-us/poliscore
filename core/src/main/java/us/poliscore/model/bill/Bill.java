...
//	}
	...
	@DynamoDbSecondarySortKey(indexNames = { Persistable.OBJECT_BY_HOT_INDEX }) public int getHot() { return (int)(getImpactAbs(TrackedIssue.OverallBenefitToSociety, 1.2d) * Math.exp(-0.015 * ChronoUnit.DAYS.between(getDate(), LocalDate.now()))); }
