...
3. The media references section is valid JSON and follows the specified format (more on that later)
...
[ { "type": "MISCONDUCT | STAKEHOLDER | NEWS | FUNDER", "mediaOrganization": "Name of the media organization or publisher", "articleTitle": "Title of the article or resource", "author": "Author name, or an empty string if unavailable", "publishedDate": "yyyy/mm/dd", "url": "https://example.com/article", "quickSummary": "A concise one-sentence summary", "longSummary": "A detailed factual summary of the relevant information", "sentiment": -50, "sentimentText": "Negative | Neutral | Positive", "trustworthiness": 85, "confidence": 90 } ]
...
Before printing the final line, internally verify the output is a JSON array of objects; each object contains exactly the keys: type, mediaOrganization, articleTitle, author, publishedDate, url, quickSummary, longSummary, sentiment, sentimentText, trustworthiness, confidence. All values except sentiment, trustworthiness, and confidence are strings. Type is one of MISCONDUCT | STAKEHOLDER | NEWS | FUNDER; publishedDate is formatted yyyy/mm/dd; sentiment is an integer from -100 to 100 describing how positively or negatively the article portrays the legislator; sentimentText is Negative, Neutral, or Positive; trustworthiness is an integer from 0 to 100 evaluating the reliability of this specific article or reference based on sourcing quality, factual support, transparency, corroboration, and the publisher's editorial standards; confidence is an integer from 0 to 100 describing confidence in the analysis. Judge trustworthiness independently from sentiment: strongly negative coverage can still be highly trustworthy, and positive coverage can be untrustworthy. Use the article's canonical URL whenever possible. If any object fails these rules, correct it before responding.
			""";
