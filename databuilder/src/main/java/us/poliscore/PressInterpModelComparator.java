...
/**
 * Used to compare two different ai models for doing press interps.
 */
...
//	            Bill bill = data.getWorkingDataset().get(original.getBillId(), Bill.class).orElse(null);
...
//                var bill = data.getWorkingDataset().get(billId, Bill.class).get();
//
